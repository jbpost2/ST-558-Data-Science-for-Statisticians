...
| M-F                     | 02 - Watch - Workflows and `Git`/`GitHub` Basics\                 |                            |
|                         | 03 - Read - `Git` and `GitHub` Practice\                          |                            |
|                         | 04 - Watch - `R` Basics\                                          |                            |
|                         | 05 - Read & Watch - `R` Projects and Connecting with `GitHub`\    |                            |
|                         | 06 - Read & Watch - `Quarto` Basics                               |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
...
| 9/15-9/19\              | 21 - Databases and Basic `SQL`\                                   |                            |
| M, W-F (Off T)          | 22 - `SQL` Joins\                                                 |                            |
|                         | 23 - Querying APIs                                                |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
...
| 9/29-10/3\              | 25 - Creating Contingency Tables\                                 |                            |
| M-F                     | 26 - Barplots and `ggplot2` Basics\                               |                            |
|                         | 27 - Numerical Variable Summaries\                                |                            |
|                         | 28 - Numerical Variable Graphs                                    |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
| Week 8\                 | 29 - Recap & Direction!\                                          | HW 6 due W, 10/15          |
| 10/6-10/10\             | 30 - `apply` Family of Functions\                                   |                            |
| M-F                     | 31 - `purrr` and List Columns\                                        |                            |
|                         | 32 - Advanced Function Writing                                    |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
| Week 9\                 | 33 - Introduction to RShiny\                                      | HW 7 due W, 10/22          |
| 10/15-10/17\            | 34 - Tutorials Part I\                                            |                            |
...
| 10/27-10/31             |                                                                   |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
| Week 12\                | 44 - Modeling Concepts\                                           | HW 8 due W, 11/12          |
| 11/3-11/7\              | 45 - Prediction & Training/Test Sets\                             |                            |
...
|                         | 54 - Ensemble Trees                                               |                            |
+-------------------------+-------------------------------------------------------------------+----------------------------+
| Week 14\                | 55 - Creating an API in `R`\                                      | Exam 2 - W-F, 11/19-11/21  |
