...
-   'Delimited' data: Character (such as <a href ="https://www4.stat.ncsu.edu/~online/datasets/scoresFull.csv" target = "_blank">','</a>, <a href ="https://www4.stat.ncsu.edu/~online/datasets/umps2012.txt" target = "_blank">'\>'</a>, or \[' '\]) separated data
-   <a href ="https://www4.stat.ncsu.edu/~online/datasets/cigarettes.txt" target = "_blank">Fixed field</a> data
-   <a href ="https://www4.stat.ncsu.edu/~online/datasets/Dry_Bean_Dataset.xlsx" target = "_blank">Excel</a> data
-   From other statistical software, Ex: <a href ="https://www4.stat.ncsu.edu/~online/datasets/bodyFat.sav" target = "_blank">SPSS formatted</a> data or <a href ="https://www4.stat.ncsu.edu/~online/datasets/house.sas7bdat" target = "_blank">SAS data sets</a>
-   From a database
...
Consider the `umps.txt` file available at: <a href = "https://www4.stat.ncsu.edu/~online/datasets/umps2012.txt" download>https://www4.stat.ncsu.edu/~online/datasets/umps2012.txt</a>
...
Once the data is read into an `R` object, we can then usually parse it with <a href = "https://en.wikipedia.org/wiki/Regular_expression" target = "_blank">**regular expressions**</a>. Hopefully, that's not something you need to do very often!
