...
```{r, out.width = "600px", echo = FALSE, fig.align='center', fig.alt = "A database table diagram is shown. Many tables are shown with some sharing 'keys' that link the data tables together."}
...
-   <a href = "https://docs.oracle.com/cd/E11882_01/server.112/e40540/intro.htm#CNCPT001Oracle" target = "_blank">Oracle</a>
-   <a href = "https://dev.mysql.com/doc/" target = "_blank">MySQL</a>
-   <a href = "https://docs.microsoft.com/en-us/sql/relational-databases/databases/databases?view=sql-server-ver15" target = "_blank">SQL Server</a>
-   <a href = "https://www.postgresql.org/about/" target = "_blank">PostgreSQL</a>
-   <a href = "https://www.sqlite.org/index.html" target = "_blank">SQLite</a>
-   <a href = "https://docs.microsoft.com/en-us/azure/azure-sql/" target = "_blank">Azure SQL</a>
