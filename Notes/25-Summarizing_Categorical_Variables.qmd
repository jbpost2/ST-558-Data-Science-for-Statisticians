...
When we create these kinds of tables, we often want to include them in some kind of final document. A great way to customize the look of tables is through the <a href = "https://gt.rstudio.com/" target = "_blank">`gt` package</a>!
...
It is easy to add lables on the columns via `cols_label()`.
