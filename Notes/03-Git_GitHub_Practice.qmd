...
- Once you have an account, <a href="https://guides.github.com/activities/hello-world/" target="_blank" rel="noopener">read this introduction to `GitHub`</a> here (we'll look at using `Git` and the command line shortly - for now we'll stick to the web editor).
