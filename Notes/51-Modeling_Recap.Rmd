...
```{r, echo = FALSE, out.width='500px', fig.align='center', fig.alt = "A scatter plot between speed (x) and distance (y) is shown with a simple linear regression model overlayed."}
...
```{r, echo = FALSE, out.width="600px", fig.alt = "A dataset is represented as a rectangle. A large portion of the rectangle represents the training data and a small section represents the testing (or holdout) sample."}
