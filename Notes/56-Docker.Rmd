...
```{r, echo = FALSE, fig.align = "center", out.width = "550px", fig.alt = ""}
...
```{r, echo = FALSE, fig.align = "center", out.width = "550px", fig.alt = "The flow of creating a Dockerfile, building a docker image, and running a docker container is shown."}
...
```{r, echo = FALSE, fig.align = "center", out.width = "625px", fig.caption="microsoft", fig.alt = "A diagram is shown describing a registry of stored docker images that can be downloaded and run to create a container that provides a site or app people can use. The registry of images includes both on-premise images and public, cloud-based, images."}
