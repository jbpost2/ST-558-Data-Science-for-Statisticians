...
```{r, echo = FALSE, out.width="800px", fig.align='center', fig.alt = "An R shiny window is shown where the first fourth of the window correponds to 'content!---...', a small space exists, and the last two-thirds of the window is taken up by 'more content!----...'."}
...
```{r, echo = FALSE, out.width="800px", fig.align='center', fig.alt = "An R shiny window is shown where two rows exist. The first row has three columns of varying widths. The second row has two columns each of width 6. The second column of the second row has a row within it split up into a column of width 3 and a column of width 9."}
...
```{r, echo = FALSE, out.width="800px", fig.align='center', fig.alt = "An R shiny window is shown where two tabs exists."}
...
```{r, echo = FALSE, out.width="800px", fig.align='center', fig.alt = "An R shiny window is shown that uses the shinydashboard set up. This, by default, has a title at the top and a menu bar on the left."}
...
```{r, echo = FALSE, out.width="800px", fig.align='center', fig.alt = "An R shiny window is shown that uses the shinydashboard set up. Within the window there are tabs in the main section of the app."}
