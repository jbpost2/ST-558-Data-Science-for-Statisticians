...
We saw some nasty column names in the video. There's a great function from the `janitor` package to quickly deal with these called `clean_names()`!
...
-   <a href = "https://rstudio.github.io/cheatsheets/html/data-transformation.html" target = "_blank">`dplyr` Cheat Sheet</a> (PDF version on the right hand side of the page)
