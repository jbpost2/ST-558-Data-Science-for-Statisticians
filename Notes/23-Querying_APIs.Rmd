...
```{r, out.width = "500px", fig.align='center', echo = FALSE, fig.alt = "Information about the 'Teams' endpoint is shown."}
...
```{r, out.width = "500px", fig.align='center', echo = FALSE, fig.alt = "Information about the 'Team Stats' endpoint is shown."}
