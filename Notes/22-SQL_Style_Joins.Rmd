...
```{r, echo = FALSE, fig.align='center', out.width = '600px', fig.alt = "A database table diagram is shown. Many tables are shown with some sharing 'keys' that link the data tables together."}
...
```{r, echo = FALSE, fig.align='center', out.width="325px", fit.alt = "Joins available in dplyr are displayed. See help(inner_join) for more information."}
...
```{r, echo = FALSE, fig.align='center', out.width="400px", fit.alt = "Set operations and other ways to combine data frames in dplyr are shown. See help(intersect) and help(bind_rows) for more information."}
...
```{r, echo = FALSE, fig.align='center', out.width="350px", fig.alt= "An inner join relationship is displayed with a venn diagram. Two circles are shown with the left representing table 1 and the right table 2. The inner join represents the intersection between these sets."}
...
```{r, echo = FALSE, fig.align='center', out.width="350px", fig.alt= "A left join relationship is displayed with a venn diagram. Two circles are shown with the left representing table 1 and the right table 2. The left join represents the entire left table including the intersection between these sets."}
...
```{r, echo = FALSE, fig.align='center', out.width="350px", fig.alt= "A right join relationship is displayed with a venn diagram. Two circles are shown with the left representing table 1 and the right table 2. The right join represents the entire right table including the intersection between these sets."}
...
```{r, echo = FALSE, fig.align='center', out.width="350px", fig.alt= "A full outer join relationship is displayed with a venn diagram. Two circles are shown with the left representing table 1 and the right table 2. The entirety of both tables is filled in, including their intersection."}
