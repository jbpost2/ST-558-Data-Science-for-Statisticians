...
```{r loadR, fig.align = 'center', out.width = "200px", echo = FALSE, fig.alt = "The global environment drop down in RStudio is shown. This lists the order of the packages read into the R session."}
...
```{r install2, out.width = "500px",echo=FALSE, fig.align='center', fig.alt = "The packages tab in RStudio is shown. This lists the packages installed on your computer and their versions."}
