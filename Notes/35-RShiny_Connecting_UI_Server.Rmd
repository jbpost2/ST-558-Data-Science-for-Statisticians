...
```{r, out.width = "100%", fig.align='center', echo = FALSE, fig.alt = "A list of shiny functions and their corresponding HTML functions is shown. Please visit https://shiny.posit.co/r/getstarted/build-an-app/customizing-ui/interface.html for more information."}
...
```{r, fig.align='center', out.width="60%", echo = FALSE, fig.alt = "Outputs and their corresponding render functions are shown. For instance, renderPlot and plotOutput are paired to create a plot (plotOutput) and show the plot (renderPlot). See https://shiny.posit.co/r/getstarted/build-an-app/hello-shiny/server-function.html for more information."}
