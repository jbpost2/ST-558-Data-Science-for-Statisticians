...
+=================+============================================================+================================+
| Week 1\         | 01 - Read - What is Data Science?\                         | HW 1 due W 5/27                |
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 2\         | 07 - Base R Data Structures: Vectors\                      | HW 2 due T, 6/2                |
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 3\         | 15 - Packages\                                             | HW 3 due T, 6/9                |
...
|                 | 22 - `SQL` Joins                                           |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 4\         | 23 - Querying APIs\                                        |  HW 4 due T 6/16               |
| M-F\            | 24 - EDA Concepts\                                         |                                |
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 5\         | No new material                                            | Project 1 due Th, 6/17         |
| 6/15-6/18\      |                                                            |                                |
| M-Th            |                                                            |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 6\         | 29 - Recap & Direction!\                                   | Exam Window M-T, 6/22-6/23\    |
| M-W\            | 30 - `apply` Family of Functions\                          | HW 5 due T, 6/30               |
| 6/22-6/24       | 31 - `purrr` & List Columns\                               |                                |
|                 | 32 - Advanced Function Writing\                            |                                |
|                 | 33 - Introduction to RShiny\                               |                                |
|                 | 34 - Tutorials Part I                                      |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 7\         | 35 - Connecting the UI and Server\                         | HW 6 due T 7/7\                |
...
|                 |                                                            |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 9\         | 44 - Modeling Concepts\                                    | HW 7 due T, 7/21               |
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 10\        | 50 - LASSO Models\                                         | HW 8 due T, 7/28               |
| M-F\            | 51 - Modeling Recap\                                       |                                |
| 7/20-7/24       | 52 - Logistic Regression Models\                           |                                |
|                 | 53 - Regression & Classification Trees\                    |                                |
|                 | 54 - Ensemble Trees                                        |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 11\        | 55 - Creating an API in `R`\                               | Final Project due M, 8/3       |
