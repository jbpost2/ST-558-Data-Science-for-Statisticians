...
```{r, out.width='20%', echo = FALSE, fig.alt = "R logo"}
knitr::include_graphics("img/R.png")
```
</div>
<div style = "float: left; width: 45%">
```{r, out.width='20%', echo = FALSE, fig.alt = "RStudio logo"}
...
```{r, out.width="450px", echo = FALSE, fig.alt = "An image of the RStudio IDE is shown."}
...
<div style = "float:left; width = 45%;">
```{r basic, echo = TRUE, out.width = "250px", fig.align='center', fig.alt = "A histogram is shown."}
mean(cars$speed)
hist(cars$speed)
```
</div>
...
```{r eval = FALSE, echo = TRUE, fig.alt = "Two plots are shown. The first is a scatterplot of speed and dist. The second is a plot of the exponential curve from 0 to 1."}
plot(cars)
plot(exp)
```
<div style = "float: left; width = 45%;">
