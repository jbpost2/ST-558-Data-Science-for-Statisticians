...
```{r, echo = FALSE, fig.align='center', out.width = "500px", fig.alt = "Flow chart with four bubbles moving from left to right. The first bubble is the initial repo, then the second represents a commit, the third and fourth also represent future commits."}
...
```{r, fig.align='center', out.width="45%", echo = FALSE, fig.alt = "A message on github shows a message saying 'This branch is 1 commit ahead of jbpost2:main.'"}
...
```{r, fig.align='center', out.width="79%", echo = FALSE, fig.alt = "The 'Pull requests' tab on github is shown. Any pull requests are listed there."}
...
```{r, fig.align='center', out.width="75%", echo = FALSE, fig.alt = "A pull request is shown. A file and its changes are displayed."}
...
```{r, fig.align='center', out.width="45%", echo = FALSE, fig.alt = "A notification on github is shown next to the 'pull requests' menu item."}
...
```{r, fig.align='center', out.width="70%", echo = FALSE, fig.alt = "The github pull request screen is shown. Here one can choose to merge a pull request."}
...
```{r, fig.align='center', out.width="70%", echo = FALSE, fig.alt = "An example of a pull request that cannot be merged automatically is shown. The user must then manage the merge themselves."}
...
```{r, fig.align='center', out.width="70%", echo = FALSE, fig.alt = "A list of conflicts on github is shown. A 'resolve conflicts' button appears, allowing the user to resolve issues."}
...
```{r, fig.align='center', out.width="70%", echo = FALSE, fig.alt = "An example conflict is shown with <<<< ===== >>>> designating the areas that must be manually selected."}
