...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 3\         | 15 - Packages\                                             | HW 3 due T, 9/8 (group W, 9/10)|
| M-F\            | 16 - Tidyverse Essentials\                                 |                                |
| 8/31-9/4        | 17 - Reading Delimited Data\                               |                                |
|                 | 18 - Reading Excel Data\                                   |                                |
|                 | 19 - Manipulating Data with dplyr\                         |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 4\         | 20 - Manipulating Data with tidyr\                         | HW 4 due M, 9/14 (group W, 9/16)|
| T-F\            | 21 - Databases and Basic `SQL`\                            |                                |
| 9/8-9/11        | 22 - `SQL` Joins\                                          |                                |
|                 | 23 - Querying APIs                                         |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 5\         | 24 - EDA Concepts\                                         | HW 5 due M, 9/21 (group W, 9/23)|
| M-F\            | 25 - Summarizing Categorical Variables\                    |                                |
| 9/14-9/18       | 26 - Barplots & ggplot2 Basics\                            |                                |
|                 | 27 - Numerical Variable Summaries\                         |                                |
|                 | 28 - Numerical Variable Graphs & More ggplot2              |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 6\         | No new material                                            | Project 1 due W, 9/30           |
| M-F\            |                                                            |                                |
| 9/21-9/25       |                                                            |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 9\         | 39 - Dynamic User Interfaces\                              | HW 8 (individual) due W, 10/2  |
| M-F\            | 40 - Flexible UI Layouts & Dashboards\                     |                                |
| 10/12-10/16     | 41 - Sharing Apps\                                         |                                |
|                 | 42 - Debugging & Useful Things\                            |                                |
|                 | 43 - Control Reactivity with `isolate()`                   |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 10\        | No new material                                            | Project 2 due W, 10/28          |
| W-F\            |                                                            |                                |
| 10/21-10/23     |                                                            |                                |
+-----------------+------------------------------------------------------------+--------------------------------+
...
+-----------------+------------------------------------------------------------+--------------------------------+
| Week 12\        | 50 - LASSO Models\                                         | HW 10 due M, 11/9 (group W, 11/11)|
| M-F\            | 51 - Modeling Recap\                                       |                                |
| 11/2-11/6       | 52 - Logistic Regression Models\                           |                                |
