...
```{r, eval=TRUE, out.width = "650px", fig.align='center', out.height = '350px', fig.alt = "A blankplot with SexF on the x-axis and two categories is shown."}
...
```{r,eval=TRUE, out.width = "600px", fig.align='center', out.height = '350px', fig.alt = "A bar plot with SexF on the x-axis is shown."}
ggplot(data = app_data |> drop_na(SexF), aes(x = SexF)) + 
  geom_bar()
```
...
```{r,eval = TRUE, echo = TRUE, out.width = "600px", fig.align='center', out.height = '350px', fig.alt = "A bar plot with Sex on the x-axis is shown."}
g <- ggplot(data = app_data |> drop_na(SexF), aes(x = SexF))
g + geom_bar() +
    labs(x = "Sex")
```
...
```{r,eval = TRUE, echo = TRUE, out.height = "300px", fig.align='center', fig.alt = "A bar plot with Sex on the x-axis is shown. The bars are colored by the DiagnosisF variable. The legend title says DiagnosisF"}
...
```{r,eval = TRUE, echo = TRUE, out.height = "300px", fig.align='center', fig.alt = "A bar plot with Sex on the x-axis is shown. The bars are colored by the Diagnosis variable. The legend title now says Diagnosis."}
g <- ggplot(data = app_data |> drop_na(SexF, DiagnosisF), aes(x = SexF, fill = DiagnosisF))
g + geom_bar() + 
  labs(x = "Sex")+ 
...
```{r,eval = TRUE, echo = TRUE, out.width = "650px", fig.align='center', out.height = '300px', fig.alt = "A bar plot with Sex on the y-axis is shown. The bars are colored by the Diagnosis variable."}
ggplot(data = app_data |> drop_na(SexF, DiagnosisF), aes(x = SexF, fill = DiagnosisF)) + 
  geom_bar() + 
  labs(x = "Sex")+ 
  scale_fill_discrete("Diagnosis")+
...
```{r,eval = TRUE, echo = TRUE, out.height = "300px", fig.align='center', message = FALSE, warning = FALSE, fig.alt = "A bar plot with SexF on the x-axis is shown. The bars are colored by the DiagnosisF variable."}
...
```{r,eval = TRUE, echo = TRUE, out.width = "600px", fig.align='center', out.height = '350px', fig.alt = "Side-by-side bar plots with Sex on the x-axis is shown. The female group has two bars, one for each diagnosis setting. Similarly, for the male group."}
ggplot(data = app_data |> drop_na(SexF, DiagnosisF), aes(x = SexF, fill = DiagnosisF)) + 
...
```{r,eval = TRUE, echo = TRUE, fig.align='center', out.height = '300px', fig.alt = "A bar plot with SexF on the x-axis is shown. The bars are colored by the DiagnosisF variable. The total bar height for each group is 1."}
ggplot(data = app_data |> drop_na(SexF, DiagnosisF), aes(x = SexF, fill = DiagnosisF)) + 
