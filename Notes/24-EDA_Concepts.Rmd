...
<div class="my-footer"><img src="img/logo.png" alt = "logo" style="height: 60px;"/></div> 
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "A bar chart of the Sex variable is shown."}
ggplot(app_data |>
  group_by(SexF) |>
  drop_na(SexF) |>
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "A bar chart of the Sex variable is shown. The bars are colored by the Diagnosis variable."}
ggplot(app_data |>
  group_by(SexF, DiagnosisF) |>
  drop_na(SexF, DiagnosisF) |>
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "Two bar charts of the Sex variable are shown, one for those with appendicitis and one for those without. The bars are colored by the Severity variable."}
ggplot(app_data |>
  group_by(SexF, DiagnosisF, SeverityF) |>
  drop_na(SexF, DiagnosisF, SeverityF) |>
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "Two density plots for the weight variable are overlayed, one curve for each value of the diagnosis variable."}
...
```{r, echo = FALSE, out.width = "400px", fig.align='center', fig.alt = "Two density plots for the weight variable are overlayed, one curve for each value of the diagnosis variable."}
ggplot(app_data |> drop_na(Weight, Diagnosis), aes(x = Weight, fill = Diagnosis)) + 
  geom_density(alpha = 0.5)
```
</div>
...
```{r, echo = FALSE, out.width = "400px", fig.align='center', fig.alt = "Two histogram plots for the weight variable are shown, one curve for each value of the diagnosis variable."}
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "A scatter plot between the age and weight variables is shown. A general positive increasing patther in an exponential manner is shown."}
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "A scatter plot between the age and weight variables is shown. The points are colored by the diagnosis variable."}
...
```{r, echo = FALSE, out.width = "700px", out.height = "400px", fig.align='center', fig.alt = "A scatter plot between the age and weight variables is shown. The points are colored by the diagnosis variable. The size of the points vary based on the length of stay variable."}
