...
- Chapters 3, 4, and 5 of R 4 Data Science (opens in new window) (LO 4.1, 4.2, 4.4, 4.5, 4.6)
- (Optional) R Packages book (opens in new window) (LO 3.5, 4.4)
- (Optional) List of CRAN approved packages (opens in new window) (LO 3.5)
- (Optional) List of useful R packages (opens in new window) (LO 4.4)
