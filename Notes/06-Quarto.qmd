...
We'll go through the basics to get you started. Much more is available on the <a href= "https://Quarto.org/docs/get-started/hello/rstudio.html" target = "_blank">Quarto docs page</a>, the <a href = "https://docs.posit.co/ide/user/ide/guide/documents/Quarto-project.html" target = "_blank">`RStudio` Quarto integration page</a>, and in the <a href = "https://r4ds.hadley.nz/Quarto" target = "_blank">*`R` for Data Science book*</a>.
...
Quarto is designed to be used in three ways (<a href = "https://r4ds.hadley.nz/quarto.html" target= "_blank">*`R` for Data Science*</a>)
