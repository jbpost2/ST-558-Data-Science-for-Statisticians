...
This second week we'll go through a systematic view of the most common data objects you'll see in `R`. We'll see how to access these objects using `BaseR` commands. 
